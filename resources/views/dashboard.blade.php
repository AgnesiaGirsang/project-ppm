...
@section('content')
    ...
    <div class="grid g4" style="margin-bottom:16px;">
        <div class="card stat blue">
            <div class="top"><span class="label">Total Pengajuan</span>
                <div class="ic">&#9638;</div>
            </div>
            <div class="num">{{ $stats['total'] }}</div>
        </div>
        <div class="card stat amber">
            <div class="top"><span class="label">Dalam Proses</span>
                <div class="ic">&#9711;</div>
            </div>
            <div class="num">{{ $stats['proses'] }}</div>
        </div>
        <div class="card stat green">
            <div class="top"><span class="label">Disetujui</span>
                <div class="ic">&#10003;</div>
            </div>
            <div class="num">{{ $stats['disetujui'] }}</div>
        </div>
        <div class="card stat red">
            <div class="top"><span class="label">Perlu Revisi</span>
                <div class="ic">&#8630;</div>
            </div>
    ...
    <div class="grid g3">
        ...
        <div class="card">
            <h3>Pengumuman</h3>
            <ul class="timeline">
                <li><b>Pengajuan "Sistem Informasi Klinik" diterima</b>
                    <div class="t">16 Mei 2026 &middot; 10:30</div>
                </li>
                <li><b>Laporan kemajuan "AI untuk Kesehatan" sudah divalidasi</b>
                    <div class="t">15 Mei 2026 &middot; 09:48</div>
                </li>
                <li class="muted"><b>Laporan hasil "Pemberdayaan UMKM" disetujui</b>
    ...
    <div class="card" style="margin-top:16px;">
        <h3>Aksi Cepat</h3>
        <div class="grid g4">
            <a href="{{ route('pengajuan.step1') }}" class="btn"
                style="flex-direction:column; padding:18px; height:auto; background:var(--green-700); color:#fff; text-decoration:none;">&#9998;
                Buat Pengajuan Baru</a>
            <a href="{{ route('laporan.kemajuan') }}" class="btn"
                style="flex-direction:column; padding:18px; height:auto; background:var(--green-700); color:#fff; text-decoration:none;">&#9636;
                Upload Laporan Kemajuan</a>
            <a href="{{ route('laporan.index', 'hasil') }}" class="btn"
                style="flex-direction:column; padding:18px; height:auto; background:var(--green-700); color:#fff; text-decoration:none;">&#9636;
                Upload Laporan Hasil</a>
            <a href="{{ route('luaran.index') }}" class="btn"
                style="flex-direction:column; padding:18px; height:auto; background:var(--green-700); color:#fff; text-decoration:none;">&#9733;
                Input Luaran</a>
        </div>
    </div>
